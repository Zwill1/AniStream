    ...
    <div className="w-full">
        ...
        <div className="w-full lg:px-4 lg:flex lg:py-1">
            <div className="flex lg:w-6/12 justify-between px-2 lg:px-10">
                <p className="flex items-center"><span className="w-3 h-3 rounded-full bg-green-500 block mx-2"></span>Watching</p>
                <p className="font-bold">{data.Watching}</p>
            </div>
            <div className="flex lg:w-6/12 justify-between px-2 lg:px-10">
                <p className="flex items-center"><span className="w-3 h-3 rounded-full bg-white block mx-2"></span>Total Entries</p>
                <p className="font-bold">{data.TotalEntries}</p>
            </div>
        </div>
        ...
        <div className="w-full lg:px-4 lg:flex lg:py-1">
            ...
            <div className="flex lg:w-6/12 justify-between px-2 lg:px-10">
                <p className="flex items-center"><span className="w-3 h-3 rounded-full bg-pink-500 block mx-2"></span>Rewatched</p>
                <p className="font-bold">{data.Rewatched}</p>
            </div>
        </div>
        ...
        <div className="w-full lg:px-4 lg:flex lg:py-1">
            <div className="flex lg:w-6/12 justify-between px-2 lg:px-10">
                ...
                <p className="font-bold">{data.OnHold}</p>
            </div>
            <div className="flex lg:w-6/12 justify-between px-2 lg:px-10">
                <p className="flex items-center"><span className="w-3 h-3 rounded-full bg-purple-500 block mx-2"></span>Episode</p>
                <p className="font-bold">{data.Episodes}</p>
            </div>
        </div>
        ...
        <div className="w-full lg:px-4 lg:flex lg:py-1">
            <div className="flex lg:w-6/12 justify-between px-2 lg:px-10">
                ...
                <p className="font-bold">{data.Dropped}</p>
            </div>
            <div className="flex lg:w-6/12 justify-between px-2 lg:px-10">
                <p className="flex items-center"><span className="w-3 h-3 rounded-full bg-gray-500 block mx-2"></span>Plan to Watch</p>
                <p className="font-bold">{data.PlanToWatch}</p>
            </div>
        </div>
